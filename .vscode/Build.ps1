...
$processOptions = @{
    ...
    ArgumentList = "-c ""$Cache"" -s ""$Cache\Files\$Application.msi"" -o ""$env:TEMP"" -q"
...
Move-Item -Path "$env:TEMP\$Application.intunewin" -Destination "$Desktop\$Application.intunewin" -Force -Verbose
explorer $Desktop
